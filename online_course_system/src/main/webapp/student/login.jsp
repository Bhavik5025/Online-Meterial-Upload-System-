...
<div>
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"
                            style="width: 100px;margin-top: 20px; background-color: #4B69D6; font-family: Poppins; font-weight: bold;color: #fff;"><label
                                style="color: #fff;">Log In</label></button>
                        <!-- <button type="submit"
			 ...
			 <div style="margin-top: 10px;">
                        <p class="text-center text-muted mt-5 mb-0">If you are new user? Register Here For  <a href="/student/student_registration" class="fw-bold text-body"><u
                                    style="font-family: Poppins; color: #4B69D6;font-weight: bold;">Student</u></a>
                        </p>
 			</div>
                </div>
