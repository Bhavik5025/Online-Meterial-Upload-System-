...
<center>
      <div class="shadow-lg p-3 mb-5 bg-white rounded"
        ...
        <div class="text-center">
          <img src="https://cdn3d.iconscout.com/3d/premium/thumb/student-online-learning-with-laptop-5559088-4644784.png" class="rounded float-left" width="200px" alt="...">
        </div>
         <div>
          <label
        ...
        <div style="display: flex;margin-top: 20px; margin-left: 70px;">
          ...
          <div class="input-bx" style="margin-left: 19px;">
              ...
              <span style="font-family: 'Poppins';font-size: large;">${student.name}</span>
          </div>
          </div>
          
           <div style="display: flex;margin-top: 20px; margin-left: 70px;">
          <i class='fa fa-mobile-phone' style="font-size:24px;margin-top: 8px;margin-bottom:20px;color: #4B69D6;"></i>
          <div class="input-bx" style="margin-left: 27px;">

              <span style="font-family: 'Poppins';font-size: large;">${student.mobile_no}</span>
          </div>
          </div>
