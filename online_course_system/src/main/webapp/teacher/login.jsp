...
<div>
			 ...
			 <div style="margin-top: 10px;">
                        <p class="text-center text-muted mt-5 mb-0">If you are new user? Register Here For  <a href="/teacher/teacher_registration" class="fw-bold text-body"><u
                                    style="font-family: Poppins; color:#4B69D6;font-weight: bold;">Teacher</u></a>
                        </p>
 			</div>
                </div>
