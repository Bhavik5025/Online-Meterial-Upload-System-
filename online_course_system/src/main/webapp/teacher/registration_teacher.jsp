...
<center>
    <div class="shadow-lg p-3 mb-5 bg-white rounded"
			...
			<form method="get" action="store_teacher_data">
			...
			<div style="display: flex;margin-top: 20px; margin-left: 70px;">
                    ...
                    <div class="input-bx" style="margin-left: 17px;">
                        ...
                        <span style="font-family: 'Poppins';">Qualification</span>
                    </div>
                </div>	
			...
			<div style="display: flex;margin-top: 20px; margin-left: 80px;">
                    ...
                    <div class="input-bx" style="margin-left: 20px;">
...
<div>
			 ...
			 <div style="margin-top: 10px;">
                        <p class="text-center text-muted mt-5 mb-0">If you are Already User? Here   <a href="/teacher/login" class="fw-bold text-body"><u
